          ...
          <Row>
            <Col lg="2" md="2">
              <div className="product__images">
                ...
                >
                  <img src={product.image01} alt="image01" className="w-50"/>
                </div>
                <div
                  className="img__item mb-3"
                  onClick={() => setPreviewImg(product.image02)}
                >
                  <img src={product.image02} alt="image02" className="w-50"/>
                </div>
                ...
                >
                  <img src={product.image03} alt="image03" className="w-50"/>
                </div>
              </div>
            </Col>
            ...
            <Col lg="4" md="4">
              <div className="product__main-img">
                <img src={previewImg} alt="previewImg" className="w-100"/>
              </div>
            </Col>
            ...
            <Col lg='12'>
              <div className="extraIngredientsGrid">
                {(Object.values(ExtraIngredients)).map((ingredient) => {
                  return (
                    <ExtraIngredient isChecked={extraIngredients.includes(ingredient)} key={ingredient}
